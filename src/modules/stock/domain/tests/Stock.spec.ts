...
export function StockEntity () {
  ...
  it('should be include itens in stock', function () {
    const quantity = 20
    const data = {
      name: 'Offices',
      branch: 'Sorocaba - SP'
  ...
  it('should be remove itens in stock', function () {
    const quantity = 5
    const data = {
      name: 'Offices',
      branch: 'Sorocaba - SP'
  ...
  it('should be true if they contain items in stock for production', function () {
    const firstItem = {
      name: faker.commerce.productName(),
      quantity: 50,
      description: faker.commerce.productDescription()
  ...
  it('should be false if they do not contain items in stock for production', function () {
